...
namespace EloFactory_Ekko
{
    internal class Program
    {
        ...
        {
            Player.SetSkin(Player.BaseSkinName, Config.Item("Ekko.SkinChanger").GetValue<bool>() ? Config.Item("Ekko.SkinChangerName").GetValue<StringList>().SelectedIndex : Player.BaseSkinId);
